...
response = ai.contextqa('GuruLaghu Technologies is a technology company specializing in the field of Artificial Intelligence. It is based out of Bengaluru, India. Its motto is, "AI to the last man". Gurudev Rao is the founder and CEO of GuruLaghu. He is also the developer of Gurunudi.',"who is the developer of Gurunudi")
print(response)

#if language other than English, then specify
response = ai.contextqa("GuruLaghu Technologies est une technologie spécialisée dans le domaine de l'intelligence artificielle. Il est basé à Bangalore, en Inde. Sa devise est \"AI au dernier homme\". Gurudev Rao est le fondateur et PDG de GuruLaghu. Il est également le développeur de Gurunudi.","qui est le développeur de Gurunudi",lang.FRENCH)
print(response)
